  ...
  let education = [
    {
      ...
      title: 'Full Stack Development, Python, JavaScript',
      start: '2024',
      end: '2025',
    },
    {
      company: 'Laramie County Community College',
      title: 'Associate of Applied Sciences ',
      start: '2008',
      end: '2011',
    },
  ]
...
function Resume() {
  let resume = [
    ...
    {
      company: 'Builders Masonry Contractors',
      title: 'Office Manager | Bookeeper',
      start: '2009',
      end: '2012',
    },
  ]
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/ciavilla"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="www.linkedin.com/in/ciera-oxner-villalpando"
